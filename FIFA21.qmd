...
FIFA calculates the overall rating of each player through a variety of variables. Since there is a lot that goes into each position (ex. marking doesn't impact a striker as much as it does a defender), choose the variables you think fit a defender best and calculate the defender rating. Then, find the residual and evaluate.
...
tibble(mean_overall = trunc(mean(tibble$ova)),
        mean_rate = trunc(mean(tibble$rating)),
...
For the table, I took the mean residual from each
